...
String ts = "RCTIplus_Registrasi_Pos_input semua field dengan data valid pada registrasi via email_1"
...
WebUI.verifyElementVisible(findTestObject("Registerpage/button/btn_next_register"))
CustomKeywords.'click.clickElement'(findTestObject("Registerpage/button/btn_next_register"))
CustomKeywords.'verify.verifyregisterstep2'()
